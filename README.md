...
This sample creates a multi-container application in an Azure Container Service (AKS) Kubernetes. The application interface has been built using Python / Flask. The data component is using Redis.
